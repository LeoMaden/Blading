...
class PSection:
    ...
    create: Callable[[dict[str, float]], Section]

    def section(self) -> Section:
        return self.create(self.params)

    def update_params(self, params: dict[str, float]) -> "PSection":
        new_params = dict(self.params, **params)
        return PSection(new_params, self.create)
